...
const projectsConfig = [
    {
        ...
        files: [
            ...
            { name: 'NABAT 777-A Plan 2', path: './plans/NABAT.777-A-2.pdf', type: 'pdf' },
            { name: 'NABAT 777-A Plan 3', path: './plans/NABAT.777-A-3.pdf', type: 'pdf' },
            { name: 'NABAT 777-A Plan 9', path: './plans/NABAT.777-A-9.pdf', type: 'pdf' },
            { name: 'Block A Ground Floor', path: './plans/NABAT.77A-EDITING-BLOCKA-GROUND FLOOR.pdf', type: 'pdf' },
            { name: 'Project Photo 1', path: './plans/1.jpg', type: 'image' },
            { name: 'Project Photo 8', path: './plans/1_Photo - 8.jpg', type: 'image' },
            { name: 'Project Photo 9', path: './plans/1_Photo - 9.jpg', type: 'image' }
        ]
    },
    {
        id: 'totango-chakif',
