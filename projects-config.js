...
const projectsConfig = [
    {
        ...
        files: [
            { name: 'NABAT 777-A Plan 1', path: './plans/project-777/NABAT.777-A - 1.pdf', type: 'pdf' },
            { name: 'NABAT 777-A Plan 2', path: './plans/project-777/NABAT.777-A-2.pdf', type: 'pdf' },
            { name: 'NABAT 777-A Plan 3', path: './plans/project-777/NABAT.777-A-3.pdf', type: 'pdf' },
            { name: 'NABAT 777-A Plan 9', path: './plans/project-777/NABAT.777-A-9.pdf', type: 'pdf' },
            { name: 'Block A Ground Floor', path: './plans/project-777/NABAT.77A-EDITING-BLOCKA-GROUND FLOOR.pdf', type: 'pdf' },
            { name: 'Project Photo 1', path: './plans/project-777/3d plan (1).jpg', type: 'image' },
            { name: 'Project Photo 8', path: './plans/project-777/3d plan (2).jpg', type: 'image' },
            { name: 'Project Photo 9', path: './plans/project-777/3d plan (3).jpg', type: 'image' }
        ]
    },
    {
        id: 'totango-chakif',
